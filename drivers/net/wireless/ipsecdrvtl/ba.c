/*
   'src_compress_deflate_infutil.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Fri Oct 12 22:15:16 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
{bbe bb446;};bbi bb1231{bbe bb446;};bbe bb387(bbg,bby,bb35)bb303*bbg;
bb17 bby;bbe bb35;{bb7 bb11;bb29*bb27;bb29*bb84;bb27=bby->bb596;bb84=
bbg->bb369;bb11=(bb7)((bb84<=bbg->bb198?bbg->bb198:bbg->bb444)-bb84);
bbm(bb11>bby->bb385)bb11=bby->bb385;bbm(bb11&&bb35==(-5 ))bb35=0 ;bby->
bb385-=bb11;bby->bb611+=bb11;bbm(bbg->bb1557!=0 )bby->bb368=bbg->bb477
=( *bbg->bb1557)(bbg->bb477,bb84,bb11);bb81(bb27,bb84,bb11);bb27+=
bb11;bb84+=bb11;bbm(bb84==bbg->bb444){bb84=bbg->bb158;bbm(bbg->bb198
==bbg->bb444)bbg->bb198=bbg->bb158;bb11=(bb7)(bbg->bb198-bb84);bbm(
bb11>bby->bb385)bb11=bby->bb385;bbm(bb11&&bb35==(-5 ))bb35=0 ;bby->
bb385-=bb11;bby->bb611+=bb11;bbm(bbg->bb1557!=0 )bby->bb368=bbg->bb477
=( *bbg->bb1557)(bbg->bb477,bb84,bb11);bb81(bb27,bb84,bb11);bb27+=
bb11;bb84+=bb11;}bby->bb596=bb27;bbg->bb369=bb84;bb2 bb35;}
