/*
   'src_pm_pgpNetPMEvents.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Fri Oct 12 22:15:16 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
bb160*bb316,bbu bb594,bbu bb947);bbu bb1870(bb302*bbj,bbq bb513);bbb
bb1848(bb302*bbj);bbb bb1960(bb302*bbj);bbu bb1792(bb302*bbj,bb402*
bb619);bbu bb1931(bb302*bbj,bb402*bb619);bbb bb1933(bb32*bbj,bb178
bb103);bbb bb1868(bb32*bbj,bb178 bb103);bbb bb1818(bb32*bbj,bbd bb26,
bbd bb948);
#ifdef UNDER_CE
#define bb1915 64
#endif
...
(bb326*bb880,bb416*bb1609);bbu bb1870(bb302*bbj,bbq bb513){bb31(bbj);
bbj->bb912=bb137(bb513,bb12(bbj->bb912[0 ]));bbm(!bbj->bb912)bb2 0 ;bbj
->bb513=bb513;bb141(&bbj->bb980);bb2 1 ;}bbb bb1848(bb302*bbj){bb31(
bbj);bbm(bbj->bb912){bb105(bbj->bb912);bbj->bb912=bb91;}bbj->bb513=0 ;
bb144(&bbj->bb980);}bbb bb1960(bb302*bbj){bb31(bbj);bb134(&bbj->bb980
);bbj->bb382=0 ;bbj->bb448=0 ;bb132(&bbj->bb980);}bbu bb1792(bb302*bbj,
bb402*bb619){bbu bb35=0 ;bb31(bb619&&bbj);bbm(bbj->bb912&&bb619){bb134
(&bbj->bb980);{bbd bb513=bbj->bb513;bbm(bbj->bb448+1 >bb513){bbj->
bb382=(bbj->bb382+1 )%bb513;bbj->bb448--;}bb81(bbj->bb912+(bbj->bb382+
bbj->bb448++)%bb513,bb619,bb12( *bb619));bb35=1 ;}bb132(&bbj->bb980);}
bb2 bb35;}bbu bb1931(bb302*bbj,bb402*bb619){bbu bb35=0 ;bb31(bb619);
bbm(bbj&&bbj->bb912&&bb619){bb134(&bbj->bb980);bbm(bbj->bb448){bbd
bb513=bbj->bb513;bb81(bb619,bbj->bb912+bbj->bb382,bb12( *bb619));bbj
->bb382=(bbj->bb382+1 )%bb513;bbj->bb448--;bb35=1 ;}bb132(&bbj->bb980);
}bb2 bb35;}bbb bb1933(bb32*bbj,bb178 bb103){bb402 bb97={0 };bb1268*
bb27=(bb1268* )bb97.bb1224;bb97.bb129=bb1353;bb81(bb27->bb103,bb103,
bb12(bb178));bb1792(&bbj->bb1041,&bb97);}bbb bb1868(bb32*bbj,bb178
bb103){bb402 bb97={0 };bb1235*bb27=(bb1235* )bb97.bb1224;bb97.bb129=
bb1355;bb81(bb27->bb103,bb103,bb12(bb178));bb1792(&bbj->bb1041,&bb97);
}bbb bb1818(bb32*bbj,bbd bb26,bbd bb948){bb402 bb97={0 };bb1265*bb27=(
bb1265* )bb97.bb1224;bb97.bb129=bb1354;bb27->bb26=bb26;bb27->bb948=
bb948;bb1792(&bbj->bb1041,&bb97);}
