/*
   'crt.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Fri Oct 12 22:15:16 2012
*/
#include"cobf.h"
#ifdef _WIN32
...
#endif
#ifdef _WIN32
bbb*bb128(bb30 bb47){bb41 bb2595 bb2374=bb2610(-1 ,-1 );
#ifdef UNDER_CE
bb28 bb27;bb2530(&bb27,bb47+4 ,0 ,bb2374);bbm(bb27) *bb27++=bb47;
#else
bb77 bb27;bb2530(&bb27,bb47,0 ,bb2374);
#endif
bb2 bb27;}bbb bb105(bbb*bb27){bbm(!bb27)bb2;
#ifdef UNDER_CE
bb2464((bb28)bb27-1 ,((bb28)bb27)[-1 ],0 );
#else
bb2464(bb27,0 ,0 );
#endif
}bbb*bb137(bb30 bb159,bb30 bb47){bbb*bb27;bb47*=bb159;bb27=bb128(bb47
);bbm(bb27)bb996(bb27,0 ,bb47);bb2 bb27;}
#endif
#ifndef _WIN32
bbe bb145(bbh bbl*bb95,bbh bbl*bb25,bbs bb272){bb1768(bb2604"\x61\x73"
"\x73\x65\x72\x74\x20\x66\x61\x69\x6c\x75\x72\x65\x3a\x20\x25\x73\x2c"
"\x20\x25\x73\x28\x25\x64\x29\n",bb95,bb25,bb272);bb2 0 ;}
#endif
bb43 bb301(bb43*bb320){bb43 bb45;
#ifdef _WIN32
bb2569 bb2088;bb2609(&bb2088);bb45=(bb43)((bb2088.bb2601-
116444736000000000i64 )/10000000i64 );
#else
bbi bb2629 bb2088;bb2573(&bb2088);bb45=(bb43)bb2088.bb2598;
#endif
bbm(bb320) *bb320=bb45;bb2 bb45;}
#ifndef _WIN32
bbe bb328(bbh bbl*bbg){bb1768("\x25\x73\n",bbg);bb2 0 ;}bbe bb322(bbh
bbl*bb19,...){bbl bb39[256 ];bbe bb11;bb2528 bb197;bb2480(bb197,bb19);
bb11=bb2439(bb39,bb12(bb39)-1 ,bb19,bb197);bb39[bb12(bb39)-1 ]=0 ;bb1768
("\x25\x73",bb39);bb2 bb11;}
#endif
