...
static struct gpio_init_data p10_init_gpios[] = {
	...
	{EXYNOS5_GPC3(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* WLAN_SDIO_CMD */
	{EXYNOS5_GPC3(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* WLAN_SDIO_D(0) */
	{EXYNOS5_GPC3(4), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* WLAN_SDIO_D(1) */
	{EXYNOS5_GPC3(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* WLAN_SDIO_D(2) */
	{EXYNOS5_GPC3(6), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
	...
	{EXYNOS5_GPX2(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
	...
	{EXYNOS5_GPH0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_ZERO,
...
static unsigned int exynos5_sleep_gpio_table[][3] = {
	...
	{EXYNOS4_GPA1(0),  S3C_GPIO_SLP_OUT0,
		S3C_GPIO_PULL_NONE},	/* AP_RXD */
	{EXYNOS4_GPA1(1),  S3C_GPIO_SLP_OUT0,
		S3C_GPIO_PULL_NONE},	/* AP_TXD */
	...
	{EXYNOS5_GPC1(0),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_NONE},	/* AMP_L_SDA_1.8V */
	{EXYNOS5_GPC1(1),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_NONE},	/* AMP_L_SCL_1.8V */
	{EXYNOS5_GPC1(2),  S3C_GPIO_SLP_OUT0,
	...
	{EXYNOS5_GPD1(0),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_NONE},	/* RGB_SDA_1.8V */
	{EXYNOS5_GPD1(1),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_NONE},	/* RGB_SCL_1.8V */
	...
	{EXYNOS5_GPE0(0),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* 5M_nRST, CIS_nRST */
	{EXYNOS5_GPE0(1),  S3C_GPIO_SLP_PREV,
		S3C_GPIO_PULL_NONE},	/* BT_nRST */
	{EXYNOS5_GPE0(2),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* BT_EN, NC */
	...
	{EXYNOS5_GPF1(0),  S3C_GPIO_SLP_OUT0,
		S3C_GPIO_PULL_NONE},	/* ACTIVE_STATE_HSIC */
	{EXYNOS5_GPF1(1),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_NONE},	/* SUSPEND_REQUEST_HSIC */
	...
	{EXYNOS5_GPG0(1),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* IRDA_DOUT_AP, NC */
	{EXYNOS5_GPG0(2),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* USB3.0_EN */
	{EXYNOS5_GPG0(3),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* LCD_APS_EN_1.8V */
	{EXYNOS5_GPG0(4),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* RESET_REQ_N */
	{EXYNOS5_GPG0(5),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* LED_BACKLIGHT_RESET */
	...
	{EXYNOS5_GPG1(5),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* TA_EN */
	...
	{EXYNOS5_GPH0(0),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* WLAN_EN */
	...
	{EXYNOS5_GPH1(4),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* NC */
	{EXYNOS5_GPH1(5),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* ACCESSORY_EN */
	...
	{EXYNOS5_GPV1(0),  S3C_GPIO_SLP_INPUT,
		S3C_GPIO_PULL_DOWN},	/* WLAN_WAKE */
...
/* Intialize gpio set in p10 board */
