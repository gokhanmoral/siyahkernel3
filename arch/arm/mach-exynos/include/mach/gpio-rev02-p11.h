...
#define	GPIO_GPS_UART_CTS	EXYNOS5_GPA0(6)
#define	GPIO_GPS_UART_RTS	EXYNOS5_GPA0(7)
#define	GPIO_GPS_UART_RXD	EXYNOS5_GPA0(4)
#define	GPIO_GPS_UART_TXD	EXYNOS5_GPA0(5)
