/* linux/arch/arm/mach-exynos/mach-p11.c
 *
...
static struct s3c_fb_platdata p11_lcd1_pdata __initdata = {
	.win[0]		= &p11_fb_win0,
	.win[1]		= &p11_fb_win1,
	.win[2]		= &p11_fb_win2,
	.default_win	= 2,
...
static struct plat_lcd_data p11_dp_lcd_data = {
	.set_power	= dp_lcd_set_power,
};

static struct platform_device p11_dp_lcd = {
	.name              = "platform-lcd",
	.dev.parent        = &s5p_device_fimd1.dev,
	.dev.platform_data = &p11_dp_lcd_data,
};

static struct video_info p11_dp_config = {
	.name			= "for p11 TEST",
#if defined(CONFIG_MACH_P11_DP_01)
	.h_total		= 2720,
	.h_active		= 2560,
...
static struct s5p_dp_platdata p11_dp_data __initdata = {
	.video_info = &p11_dp_config,
...
static struct samsung_bl_gpio_info p11_bl_gpio_info = {
	.no = GPIO_LCD_PWM_IN_18V,
	.func = S3C_GPIO_SFN(2),
};

static struct platform_pwm_backlight_data p11_bl_data = {
	.pwm_id = 0,
	.pwm_period_ns	= 10000,
};
#endif
...
static struct max77686_platform_data exynos4_max77686_info = {
		...
		.buck3_voltage[0] = 1000000,    /* 1.0V */
		.buck3_voltage[1] = 1000000,    /* 1.0V */
		.buck3_voltage[2] = 1000000,    /* 1.0V */
		.buck3_voltage[3] = 1000000,    /* 1.0V */
		.buck3_voltage[4] = 1000000,    /* 1.0V */
		.buck3_voltage[5] = 1000000,    /* 1.0V */
		.buck3_voltage[6] = 1000000,    /* 1.0V */
		.buck3_voltage[7] = 1000000,    /* 1.0V */

		.buck4_voltage[0] = 1000000,    /* 1.0V */
		.buck4_voltage[1] = 1000000,    /* 1.0V */
		.buck4_voltage[2] = 1000000,    /* 1.0V */
		.buck4_voltage[3] = 1000000,    /* 1.0V */
		.buck4_voltage[4] = 1000000,    /* 1.0V */
		.buck4_voltage[5] = 1000000,    /* 1.0V */
		.buck4_voltage[6] = 1000000,    /* 1.0V */
		.buck4_voltage[7] = 1000000,    /* 1.0V */
};
...
struct gpio_keys_button p11_buttons[] = {
...
struct gpio_keys_platform_data p11_gpiokeys_platform_data = {
	p11_buttons,
	ARRAY_SIZE(p11_buttons),
};

static struct platform_device p11_keypad = {
	.name   = "gpio-keys",
	.dev    = {
		.platform_data = &p11_gpiokeys_platform_data,
	},
};
...
static void __init p11_map_io(void)
{
...
static void p11_power_off(void)
{
...
static void __init p11_machine_init(void)
{
	...
	s5p_fimd1_set_platdata(&p11_lcd1_pdata);
#endif

#ifdef CONFIG_BACKLIGHT_PWM
	samsung_bl_set(&p11_bl_gpio_info, &p11_bl_data);
#endif
...
#ifdef CONFIG_S5P_DP
	s5p_dp_set_platdata(&p11_dp_data);
#endif
	...
	exynos5_sleep_gpio_table_set = p11_config_sleep_gpio_table;
	...
	In case of P11, Gscaler should use MPLL(266MHz) because FIMD uses VPLL(86MHz).
